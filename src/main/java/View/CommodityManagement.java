...
public class CommodityManagement {
    ...
    private static void insertDataDirectly() {
        ...
        repo.getList().get(0).getShipments().add(new Shipment(new BigDecimal("20"), new BigDecimal("20000"), LocalDate.of(2023, 3, 13), LocalDate.of(2023, 11, 14), idGenerator.generateID(Shipment.class.getName(), 8)));
        repo.getList().get(0).getShipments().add(new Shipment(new BigDecimal("40"), new BigDecimal("19000"), LocalDate.of(2023, 3, 15), LocalDate.of(2023,11, 16), idGenerator.generateID(Shipment.class.getName(), 8)));
        repo.getList().get(0).getShipments().add(new Shipment(new BigDecimal("30000"), new BigDecimal("18000"), LocalDate.of(2023, 3, 17), LocalDate.of(2023, 11, 18), idGenerator.generateID(Shipment.class.getName(), 8)));
        repo.getList().get(1).getShipments().add(new Shipment(new BigDecimal("50"), new BigDecimal("3000"), LocalDate.of(2023, 3, 13), LocalDate.of(2023, 11, 14), idGenerator.generateID(Shipment.class.getName(), 8)));
        repo.getList().get(1).getShipments().add(new Shipment(new BigDecimal("20"), new BigDecimal("4000"), LocalDate.of(2023, 3, 15), LocalDate.of(2023,11, 16), idGenerator.generateID(Shipment.class.getName(), 8)));
        repo.getList().get(1).getShipments().add(new Shipment(new BigDecimal("10"), new BigDecimal("5000"), LocalDate.of(2023, 3, 17), LocalDate.of(2023, 11, 18), idGenerator.generateID(Shipment.class.getName(), 8)));
        repo.getList().get(2).getShipments().add(new Shipment(new BigDecimal("35"), new BigDecimal("5000"), LocalDate.of(2023, 3, 13), LocalDate.of(2023, 11, 14), idGenerator.generateID(Shipment.class.getName(), 8)));
        repo.getList().get(2).getShipments().add(new Shipment(new BigDecimal("22"), new BigDecimal("6000"), LocalDate.of(2023, 3, 15), LocalDate.of(2023, 11, 16), idGenerator.generateID(Shipment.class.getName(), 8)));
        repo.getList().get(2).getShipments().add(new Shipment(new BigDecimal("29"), new BigDecimal("7000"), LocalDate.of(2023, 3, 17), LocalDate.of(2023, 11, 18), idGenerator.generateID(Shipment.class.getName(), 8)));
        repo.getList().get(3).getShipments().add(new Shipment(new BigDecimal("50"), new BigDecimal("2500"), LocalDate.of(2023, 3, 13), LocalDate.of(2023, 11, 14), idGenerator.generateID(Shipment.class.getName(), 8)));
        repo.getList().get(3).getShipments().add(new Shipment(new BigDecimal("51"), new BigDecimal("2400"), LocalDate.of(2023, 3, 15), LocalDate.of(2023, 11, 16), idGenerator.generateID(Shipment.class.getName(), 8)));
        repo.getList().get(3).getShipments().add(new Shipment(new BigDecimal("33"), new BigDecimal("2100"), LocalDate.of(2023, 3, 17), LocalDate.of(2023, 11, 18), idGenerator.generateID(Shipment.class.getName(), 8)));
        repo.getList().get(4).getShipments().add(new Shipment(new BigDecimal("56"), new BigDecimal("4500"), LocalDate.of(2023, 3, 13), LocalDate.of(2023, 11, 14), idGenerator.generateID(Shipment.class.getName(), 8)));
        repo.getList().get(4).getShipments().add(new Shipment(new BigDecimal("44"), new BigDecimal("4700"), LocalDate.of(2023, 3, 15), LocalDate.of(2023, 11, 16), idGenerator.generateID(Shipment.class.getName(), 8)));
        repo.getList().get(4).getShipments().add(new Shipment(new BigDecimal("33"), new BigDecimal("3800"), LocalDate.of(2023, 3, 17), LocalDate.of(2023, 11, 18), idGenerator.generateID(Shipment.class.getName(), 8)));
        repo.getList().get(5).getShipments().add(new Shipment(new BigDecimal("22"), new BigDecimal("2500"), LocalDate.of(2023, 3, 13), LocalDate.of(2023, 11, 14), idGenerator.generateID(Shipment.class.getName(), 8)));
        repo.getList().get(5).getShipments().add(new Shipment(new BigDecimal("46"), new BigDecimal("2700"), LocalDate.of(2023, 3, 15), LocalDate.of(2023, 11, 16), idGenerator.generateID(Shipment.class.getName(), 8)));
        repo.getList().get(5).getShipments().add(new Shipment(new BigDecimal("68"), new BigDecimal("2200"), LocalDate.of(2023, 3, 17), LocalDate.of(2023, 11, 18), idGenerator.generateID(Shipment.class.getName(), 8)));
        repo.getList().get(6).getShipments().add(new Shipment(new BigDecimal("42"), new BigDecimal("4000"), LocalDate.of(2023, 3, 13), LocalDate.of(2023, 11, 14), idGenerator.generateID(Shipment.class.getName(), 8)));
        repo.getList().get(6).getShipments().add(new Shipment(new BigDecimal("65"), new BigDecimal("4300"), LocalDate.of(2023, 3, 15), LocalDate.of(2023, 11, 16), idGenerator.generateID(Shipment.class.getName(), 8)));
        repo.getList().get(6).getShipments().add(new Shipment(new BigDecimal("26"), new BigDecimal("5000"), LocalDate.of(2023, 3, 17), LocalDate.of(2023, 11, 18), idGenerator.generateID(Shipment.class.getName(), 8)));
        repo.getList().get(7).getShipments().add(new Shipment(new BigDecimal("33"), new BigDecimal("1000"), LocalDate.of(2023, 3, 13), LocalDate.of(2025, 10, 14), idGenerator.generateID(Shipment.class.getName(), 8)));
        repo.getList().get(7).getShipments().add(new Shipment(new BigDecimal("77"), new BigDecimal("1200"), LocalDate.of(2023, 3, 15), LocalDate.of(2025, 10, 16), idGenerator.generateID(Shipment.class.getName(), 8)));
        repo.getList().get(7).getShipments().add(new Shipment(new BigDecimal("88"), new BigDecimal("1000"), LocalDate.of(2023, 3, 17), LocalDate.of(2025, 10, 18), idGenerator.generateID(Shipment.class.getName(), 8)));
        repo.getList().get(8).getShipments().add(new Shipment(new BigDecimal("13"), new BigDecimal("800"), LocalDate.of(2023, 3, 13), LocalDate.of(2025, 10, 14), idGenerator.generateID(Shipment.class.getName(), 8)));
        repo.getList().get(8).getShipments().add(new Shipment(new BigDecimal("16"), new BigDecimal("750"), LocalDate.of(2023, 3, 15), LocalDate.of(2025, 10, 16), idGenerator.generateID(Shipment.class.getName(), 8)));
        repo.getList().get(8).getShipments().add(new Shipment(new BigDecimal("44"), new BigDecimal("700"), LocalDate.of(2023, 3, 17), LocalDate.of(2025, 10, 18), idGenerator.generateID(Shipment.class.getName(), 8)));
        repo.getList().get(9).getShipments().add(new Shipment(new BigDecimal("15"), new BigDecimal("700"), LocalDate.of(2023, 3, 13), LocalDate.of(2025, 10, 14), idGenerator.generateID(Shipment.class.getName(), 8)));
        repo.getList().get(9).getShipments().add(new Shipment(new BigDecimal("17"), new BigDecimal("750"), LocalDate.of(2023, 3, 15), LocalDate.of(2025, 10, 16), idGenerator.generateID(Shipment.class.getName(), 8)));
        repo.getList().get(9).getShipments().add(new Shipment(new BigDecimal("44"), new BigDecimal("750"), LocalDate.of(2023, 3, 17), LocalDate.of(2025, 10, 18), idGenerator.generateID(Shipment.class.getName(), 8)));
        repo.getList().get(10).getShipments().add(new Shipment(new BigDecimal("42"), new BigDecimal("3000"), LocalDate.of(2023, 3, 13), LocalDate.of(2025, 10, 14), idGenerator.generateID(Shipment.class.getName(), 8)));
        repo.getList().get(10).getShipments().add(new Shipment(new BigDecimal("19"), new BigDecimal("3000"), LocalDate.of(2023, 3, 15), LocalDate.of(2025, 10, 16), idGenerator.generateID(Shipment.class.getName(), 8)));
        repo.getList().get(10).getShipments().add(new Shipment(new BigDecimal("18"), new BigDecimal("4000"), LocalDate.of(2023, 3, 17), LocalDate.of(2025, 10, 18), idGenerator.generateID(Shipment.class.getName(), 8)));
        repo.getList().get(11).getShipments().add(new Shipment(new BigDecimal("15"), new BigDecimal("11000"), LocalDate.of(2023, 3, 13), LocalDate.of(2024, 3, 14), idGenerator.generateID(Shipment.class.getName(), 8)));
        repo.getList().get(11).getShipments().add(new Shipment(new BigDecimal("22"), new BigDecimal("11000"), LocalDate.of(2023, 3, 15), LocalDate.of(2024, 3, 16), idGenerator.generateID(Shipment.class.getName(), 8)));
        repo.getList().get(11).getShipments().add(new Shipment(new BigDecimal("23"), new BigDecimal("12000"), LocalDate.of(2023, 3, 17), LocalDate.of(2024, 3, 18), idGenerator.generateID(Shipment.class.getName(), 8)));
        repo.getList().get(12).getShipments().add(new Shipment(new BigDecimal("32"), new BigDecimal("24000"), LocalDate.of(2023, 3, 13), LocalDate.of(2024, 3, 14), idGenerator.generateID(Shipment.class.getName(), 8)));
        repo.getList().get(12).getShipments().add(new Shipment(new BigDecimal("31"), new BigDecimal("24000"), LocalDate.of(2023, 3, 15), LocalDate.of(2024, 3, 16), idGenerator.generateID(Shipment.class.getName(), 8)));
        repo.getList().get(12).getShipments().add(new Shipment(new BigDecimal("33"), new BigDecimal("25000"), LocalDate.of(2023, 3, 17), LocalDate.of(2024, 3, 18), idGenerator.generateID(Shipment.class.getName(), 8)));
        repo.getList().get(13).getShipments().add(new Shipment(new BigDecimal("35"), new BigDecimal("25000"), LocalDate.of(2023, 3, 13), LocalDate.of(2023, 11, 14), idGenerator.generateID(Shipment.class.getName(), 8)));
        repo.getList().get(13).getShipments().add(new Shipment(new BigDecimal("37"), new BigDecimal("25000"), LocalDate.of(2023, 3, 15), LocalDate.of(2023, 11, 16), idGenerator.generateID(Shipment.class.getName(), 8)));
        repo.getList().get(13).getShipments().add(new Shipment(new BigDecimal("28"), new BigDecimal("25000"), LocalDate.of(2023, 3, 17), LocalDate.of(2023, 11, 18), idGenerator.generateID(Shipment.class.getName(), 8)));
        repo.getList().get(14).getShipments().add(new Shipment(new BigDecimal("43"), new BigDecimal("2000"), LocalDate.of(2023, 3, 13), LocalDate.of(2023, 12, 14), idGenerator.generateID(Shipment.class.getName(), 8)));
        repo.getList().get(14).getShipments().add(new Shipment(new BigDecimal("22"), new BigDecimal("2000"), LocalDate.of(2023, 3, 15), LocalDate.of(2023, 12, 16), idGenerator.generateID(Shipment.class.getName(), 8)));
        repo.getList().get(14).getShipments().add(new Shipment(new BigDecimal("25"), new BigDecimal("2000"), LocalDate.of(2023, 3, 17), LocalDate.of(2023, 12, 18), idGenerator.generateID(Shipment.class.getName(), 8)));
        repo.getList().get(15).getShipments().add(new Shipment(new BigDecimal("23"), new BigDecimal("6500"), LocalDate.of(2023, 3, 13), LocalDate.of(2023, 10, 14), idGenerator.generateID(Shipment.class.getName(), 8)));
        repo.getList().get(15).getShipments().add(new Shipment(new BigDecimal("27"), new BigDecimal("6500"), LocalDate.of(2023, 3, 15), LocalDate.of(2023, 10, 16), idGenerator.generateID(Shipment.class.getName(), 8)));
        repo.getList().get(15).getShipments().add(new Shipment(new BigDecimal("11"), new BigDecimal("6500"), LocalDate.of(2023, 3, 17), LocalDate.of(2023, 10, 18), idGenerator.generateID(Shipment.class.getName(), 8)));
